...
const { UNIT_INTEGRATION_TEST_FILE_PATTERNS } = require('../utils/patterns.js');
const { convertErrorsToWarnings } = require('../utils/utils.js');
const { VITEST_CONFIG_FILE_PATTERNS } = require('../utils/patterns');

module.exports = tseslint.config(
  {
    files: VITEST_CONFIG_FILE_PATTERNS,
    rules: {
      '@nx/workspace-vitest-config-has-unique-cachedir-configured': 'error',
      '@nx/workspace-vitest-config-has-test-coverage-configured': 'error'
    }
  },
  {
