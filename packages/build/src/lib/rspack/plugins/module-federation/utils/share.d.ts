 ...
 */
export declare function getNpmPackageSharedConfig(
  pkgName: string,
  version: string
 ...
 */
export declare function sharePackages(
  packages: string[]
 ...
 */
export declare function applySharedFunction(
 ...
 */
export declare function applyAdditionalShared(
  sharedConfig: Record<string, SharedLibraryConfig>,
